    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-surface)] relative overflow-hidden px-4">
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in-up">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-cyan-400 to-violet-500 mb-4 animate-pulse-glow">
          ...
          <p className="text-[var(--color-text-dim)] mt-2">Welcome back! Sign in to your account</p>
        </div>
        ...
        <div className="glass rounded-2xl p-8 space-y-6">
          ...
          <p className="text-center text-sm text-[var(--color-text-dim)]">
            ...
            <Link to="/signup" className="text-cyan-400 hover:text-cyan-300 font-medium transition-colors">
              Sign Up <Sparkles className="w-3 h-3 inline" />
            </Link>
          </p>
        </div>
      </div>
